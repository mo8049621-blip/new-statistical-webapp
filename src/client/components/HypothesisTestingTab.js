...
import { Box, Text, Grid, Select, FormControl, FormLabel, Input, Button, Card, CardBody, Alert, AlertIcon, Stack, Tabs, TabList, TabPanels, Tab, TabPanel } from '@chakra-ui/react';
import { performZTest, performTTest } from '../utils/statistics';
import PowerFunction from './PowerFunction';

const HypothesisTestingTab = ({ dataset }) => {
    ...
    return (
        <Box>
            <Text fontSize="xl" fontWeight="bold" mb={4}>Hypothesis Testing</Text>
            <Tabs size="lg" colorScheme="blue" variant="enclosed">
                <TabList>
                    <Tab>One-Sample Mean Test</Tab>
                            ...
                            <CardBody>
                                <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(3, 1fr)' }} gap={4}>
                                    ...
                                    <FormControl>
                                        ...
                                        <Select value={varianceType} onChange={(e) => setVarianceType(e.target.value)}>
                                ...
                                <Button onClick={handleTest} mt={4} colorScheme="blue" size="lg">
                                    Perform Hypothesis Test
                                </Button>
                            </CardBody>
                        </Card>
                                    ...
                                    <Stack spacing={3}>
                                        ...
                                        <Box>
                                            ...
                                            <Text color={testResult.rejected ? "red.600" : "green.600"}>
                                                {testResult.rejected ? `At significance level α = ${alpha}, reject the null hypothesis H₀` : `At significance level α = ${alpha}, fail to reject the null hypothesis H₀`}
                                            </Text>
                                        </Box>
                                        <Box>
